...
public class MobileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void initView() {
        ...
        navMobile.getMenu().findItem(R.id.nav_mobile).setChecked(true);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            redirectActivity(MobileActivity.this, MainActivity.class);
        } else if (id == R.id.navMobile) {
            item.setChecked(true);
            restartActivity(this);
        } else if (id == R.id.nav_laptop) {
            item.setChecked(true);
            redirectActivity(MobileActivity.this, LaptopActivity.class);
        } else if (id == R.id.nav_history) {
            item.setChecked(true);
            redirectActivity(MobileActivity.this, HistoryActivity.class);
            ...
            redirectActivity(MobileActivity.this, SearchActivity.class);
        }
        else if(id == R.id.nav_contact_us){
            item.setChecked(true);
            redirectActivity(MobileActivity.this, ContactInforActivity.class);
        }
        else if(id == R.id.nav_about_us){
            item.setChecked(true);
            redirectActivity(MobileActivity.this, AboutUsActivity.class);
        }
        else if(id == R.id.nav_myprofile){
            item.setChecked(true);
            redirectActivity(MobileActivity.this, ProfileActivity.class);
        }
        else if(id == R.id.nav_wish_list){
            item.setChecked(true);
            redirectActivity(MobileActivity.this, WishList.class);
        }
